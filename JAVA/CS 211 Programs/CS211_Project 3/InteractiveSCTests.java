...
public class InteractiveSCTests {
  ...
  @Test(timeout=6000) public void isc_correctword_2(){
    boolean ignoreCase = false;
    String dictFile = "google-10000-english.txt";
    int expectDictSize = 0;
    Object words_correct[][] = {
  ...
  @Test(timeout=6000) public void isc_correctdoc_ignorecase_1(){
    boolean ignoreCase = true;
    String dictFile = "does-not-exist.txt";
    int expectDictSize = 0;
    Object docs_correct[][] = {
  ...
  @Test(timeout=6000) public void isc_correctdoc_ignorecase_2(){
    boolean ignoreCase = true;
    String dictFile = "short-dict.txt";
    Object docs_correct[][] = {
      {"Apple, banana, CARROT!",
  ...
  @Test(timeout=6000) public void isc_correctdoc_ignorecase_3(){
    boolean ignoreCase = true;
    String dictFile = "short-dict.txt";
    Object docs_correct[][] = {
  ...
  @Test(timeout=6000) public void isc_correctdoc_ignorecase_4(){
    boolean ignoreCase = true;
    String dictFile = "google-10000-english.txt";
    Object docs_correct[][] = {
  ...
  @Test(timeout=6000) public void isc_correctdoc_noignorecase_1(){
    boolean ignoreCase = false;
    String dictFile = "google-10000-english.txt";
    Object docs_correct[][] = {
      {"One potatoe, two tumatoes, three potatoes, four. I misunderestimated how many potatoes.",
