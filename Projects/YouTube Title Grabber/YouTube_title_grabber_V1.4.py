...
def main():
	...
	youtube = googleapiclient.discovery.build(api_service_name, api_version, credentials=loadKey())

	request = youtube.playlistItems().list(
		part="snippet,contentDetails",
		maxResults=50,
		playlistId=parseURL(input("Please Enter A Playlist URL: "))
		)
